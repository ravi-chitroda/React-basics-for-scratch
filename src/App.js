...
function App() {
  ...
  const books = [
    {
      img: "https://images-na.ssl-images-amazon.com/images/I/51I6vQLJD+L._SX258_BO1,204,203,200_.jpg",
      title: "Spirituality For Leadership & Success",
      author: "Vivekananda",
    },
    {
    ...
    {
      img: "https://images-eu.ssl-images-amazon.com/images/I/51PJyvcfPGL._SY264_BO1,204,203,200_QL40_FMwebp_.jpg",
  ...
  const Book = (props) => {
    //here we can write either props or can direct pass key or properties into this like {img, title, author} this is called destructuring
